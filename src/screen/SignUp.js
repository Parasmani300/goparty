...
export default function SignUp() {
    ...
    const signUpUser = (email,passowrd) => 
    {
            ...
            <Paper elevation={10} style={paperStyle}>
                ...
                />
                    ...
                    <FormControlLabel
                        ...
                        label="Remember Me"
                    />
                <Button variant='contained' color='primary' fullWidth style={marginBtn} onClick={()=>signUpUser(userEmail,password)}>Create Account</Button>
                <Typography>
                    Existing User?
                    <Link href="#" onClick={()=>navigate("/")}> Sign In.</Link>
                </Typography>
